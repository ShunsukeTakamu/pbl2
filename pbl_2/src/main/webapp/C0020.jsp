			...
			<div class="row g-4">
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					...
					<div class="card shadow-sm border-0 rounded-3">
						...
						<div class="card-footer bg-transparent border-0 pt-0">
							<canvas id="flush-area-chart-blue" height="0"></canvas>
						</div>
					</div>
				</div>
				<!-- 総売上 -->
				<div class="col-lg-3 col-md-6 col-sm-12">
					...
					<div class="card shadow-sm border-0 rounded-3">
						<div class="card-body">
							...
							<div class="card-footer bg-transparent border-0 pt-0">
							<canvas id="flush-area-chart-blue" height="42"></canvas>
						</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="card shadow-sm border-0 rounded-3">
						...
						<div class="card-footer bg-transparent border-0 pt-0">
							<canvas id="flush-area-chart-yellow" height="42"></canvas>
						</div>
					</div>
				</div>
