    ...
    <form action="S0040.html" method="post">
      ...
      <div class="row align-items-center mb-3">
        ...
        <div class="col-12 col-md-9">
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="authNone" name="authorities" value="0"
              <c:if test="${fn:contains(sessionScope.searchAuthorities, '0')}">checked</c:if>>
            <label class="form-check-label" for="authNone">権限なし</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="authSales" name="authorities" value="1"
              <c:if test="${fn:contains(sessionScope.searchAuthorities, '1')}">checked</c:if>>
            <label class="form-check-label" for="authSales">売上登録</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="authAccount" name="authorities" value="2"
      ...
      <div class="row">
        <div class="col-12 text-center">
          ...
          <button type="reset" class="btn btn-outline-secondary" onclick="resetAuthority()">クリア</button>
        </div>
      </div>
    </form>
  </main>
