...
public class SaleValidation {
	...
	// 0010
    public static ReturnPair validateRegistration(SaleForm form) throws IOException {
        ...
        try {
            ...
            } else if (!(new AccountService()).isValidById(accountId)) {
        ...
        try {
            ...
            } else if (!(new CategoryService()).isValidById(categoryId)) {
